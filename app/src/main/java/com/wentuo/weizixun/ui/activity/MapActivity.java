...
import com.wentuo.weizixun.utils.PoiOverlay;
import com.wentuo.weizixun.utils.WalkingRouteOverlay;
...
//        setContentView(mapview);
    ...
    @OnClick({R.id.btn_location, R.id.btn_marker, R.id.btn_pio, R.id.bnt_guide, R.id.bnt_path,R.id.bnt_serach})
    ...
    private void routeWalkPlanWithParam() {
        ...
        //起终点位置
        startPt =new LatLng(getlocation.getLatitude(), getlocation.getLongitude());
        endPt = new LatLng(getlocation.getLatitude(), getlocation.getLongitude());
        Toast.makeText(this, getlocation.getLatitude()+getlocation.getLatitude()+"", Toast.LENGTH_SHORT).show();
...
//        }
//
//        public MyMapView(Context context, BaiduMapOptions baiduMapOptions) {
//            super(context, baiduMapOptions);
//        }
//    }
}
